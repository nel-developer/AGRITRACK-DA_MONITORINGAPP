...
class ResponsiveHelper {
  ...
  double scaleFont(double value) =>
      value * (_size.width / 360).clamp(0.9, 1.5);
  ...
  // ── Splash tokens ───────────────────────────────────────────────
  double get splashDaLogoSize     => (_size.height * (isWide ? 0.18 : 0.22)).clamp(100.0, 220.0);
  double get splashBrandFontSize  => scaleFont(isWide ? 48 : 34);
  double get splashSubFontSize    => scaleFont(isWide ? 13 : 9);
