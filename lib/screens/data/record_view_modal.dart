  ...
  List<_SectionDef> _sectionsForType(String type) {
    ...
    switch (type) {
      case 'crop':
        ...
        return sections;
      case 'livestock':
        final livestockInfoFields = [
          const _FieldDef('Breed', 'breed'),
          const _FieldDef('Inputs Received from FCA', 'inputsReceived'),
          const _FieldDef('Inputs Purchased by Farmer', 'inputsPurchased'),
          const _FieldDef('Farmgate Prices', 'farmgatePrices'),
        ];
        if (!isCollective) {
          livestockInfoFields.insert(
              0, const _FieldDef('Name of Farmer', 'memberName'));
        }
        ...
        return [
          ...
          _SectionDef('Livestock Information', livestockInfoFields),
          const _SectionDef('Production Information', [
            _FieldDef('Stocks Received', 'stocksReceived'),
            _FieldDef('Date Received', 'dateReceived'),
            _FieldDef('Male Stocks', 'maleStocks'),
            _FieldDef('Female Stocks', 'femaleStocks'),
            ...
            _FieldDef('Pregnant Stocks', 'pregnantStocks'),
            _FieldDef('Housing Type', 'housingType'),
            _FieldDef('Farm Ownership', 'farmOwnership'),
            _FieldDef('Farm Ownership Other', 'farmOwnershipOther'),
            _FieldDef('Usufruct Agreement', 'usufruct'),
            _FieldDef('Usufruct Remarks', 'usufructRemarks'),
            _FieldDef('Health Activities', 'healthActivities'),
            _FieldDef('Health Others', 'healthOthers'),
            _FieldDef('Waste Management', 'wasteManagement'),
          ]),
          const _SectionDef('Feeding & Water', [
            _FieldDef('Grazing Area', 'grazingArea'),
            _FieldDef('Feeds', 'feeds'),
            _FieldDef('Water Sources', 'waterSources'),
          ]),
          const _SectionDef('Harvesting & Production', [
            _FieldDef('Purpose - Breeding', 'purposeBreeding'),
            _FieldDef('Purpose - Meat/Fattener', 'purposeMeat'),
            _FieldDef('Purpose - Dairy', 'purposeDairy'),
            _FieldDef('Grow-out Period', 'growOutPeriod'),
            _FieldDef('Lactation Period', 'lactationPeriod'),
            _FieldDef('Dry Period', 'dryPeriod'),
            _FieldDef('Sold as Liveweight', 'soldAsLiveweight'),
            _FieldDef('Sold as Liveweight Remarks', 'soldAsLiveweightRemarks'),
            _FieldDef('Avg Marketable Weight', 'avgMarketableWeight'),
            _FieldDef('Milk Volume Daily', 'milkVolumeDaily'),
            _FieldDef('Farmgate Price - Milk', 'farmgatePriceMilk'),
            _FieldDef('Milk Unit', 'milkUnit'),
            _FieldDef('Slaughtered Count', 'slaughteredCount'),
            _FieldDef('Slaughtered Price', 'slaughteredPrice'),
            _FieldDef('Produced Offspring', 'producedOffspring'),
            _FieldDef('Offspring Male', 'offspringMale'),
            _FieldDef('Offspring Female', 'offspringFemale'),
            _FieldDef('Offspring M:F Ratio', 'offspringMFRatio'),
            _FieldDef('Mortalities After Birth', 'mortalitiesAfterBirth'),
            _FieldDef('Remaining Offspring', 'remainingOffspring'),
            _FieldDef('Postharvest', 'postharvest'),
            _FieldDef('Postharvest Remarks', 'postharvestRemarks'),
            _FieldDef('Processing', 'processing'),
            _FieldDef('Processing Remarks', 'processingRemarks'),
          ]),
          const _SectionDef('Livestock Damage Information', [
            _FieldDef('Has Pest', 'hasPest'),
            _FieldDef('Pest Occurrence', 'pestOccurrence'),
            _FieldDef('Pest Date', 'pestDate'),
            _FieldDef('Pest Mortality', 'pestMortality'),
            _FieldDef('Pest Treatment', 'pestTreatment'),
            _FieldDef('Pest Attached', 'pestAttached'),
            _FieldDef('Has Disease', 'hasDisease'),
            _FieldDef('Disease Occurrence', 'diseaseOccurrence'),
            _FieldDef('Disease Date', 'diseaseDate'),
            _FieldDef('Disease Mortality', 'diseaseMortality'),
            _FieldDef('Disease Treatment', 'diseaseTreatment'),
            _FieldDef('Disease Attached', 'diseaseAttached'),
            ...
            _FieldDef('Env Treatment', 'envTreatment'),
            _FieldDef('Env Attached', 'envAttached'),
            _FieldDef('Has Human-Induced', 'hasHumanInduced'),
            _FieldDef('Human Occurrence', 'humanOccurrence'),
            _FieldDef('Human Date', 'humanDate'),
            _FieldDef('Human Mortality', 'humanMortality'),
            _FieldDef('Human Remaining Stocks', 'humanRemainingStocks'),
            _FieldDef('Human Treatment', 'humanTreatment'),
            _FieldDef('Human Attached', 'humanAttached'),
          ]),
          const _SectionDef('Trainings Attended', [
            _FieldDef('Training', 'trainingsSummary'),
          ]),
