...
class _LivestockMonitoringSummaryScreenState
  ...
  late final List<LivestockMember> _members = widget.members ?? [
    LivestockMember(name: 'Juan Dela Cruz'),
    LivestockMember(name: 'Maria Santos'),
    LivestockMember(name: 'Pedro Reyes'),
    LivestockMember(name: 'Ana Bautista'),
    LivestockMember(name: 'Jose Ramos'),
  ];
  ...
  void _addAnotherFarmer() {
    ...
    Navigator.of(context).pushNamed(AppRoutes.livestockStep1, arguments: next);
  }
  ...
  void _addBatchForMember(LivestockMember member) {
    final next = LivestockStepWrapper()
      ..fcaName              = widget.wrapper.fcaName
      ..region               = widget.wrapper.region
      ..province             = widget.wrapper.province
                    ...
                    Row(children: [
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            [
                              if (w.primaryIntervention != null) w.primaryIntervention!,
