...
class _Step3State extends State<PoultryStep3ProductionInformation> {
  ...
  String _eggsSold              = '';
  String _breedingPostharvestFile   = '';
  String _breedingPostharvestRemark = '';
  String _breedingProcessingFile    = '';
  String _breedingProcessingRemark  = '';
  ...
  String _broilerPostharvestFile   = '';
  String _broilerPostharvestRemark = '';
  String _broilerProcessingFile    = '';
  String _broilerProcessingRemark  = '';
  ...
  String _layerPostharvestFile      = '';
  String _layerPostharvestRemark    = '';
  String _layerProcessingFile       = '';
  String _layerProcessingRemark     = '';
  ...
  void _next() {
    ...
    w.chicksSold                = _chicksSold.map((c) => '${c.count} (age: ${c.age})').join(', ');
    w.eggsSold                  = _eggsSold;
    w.breedingPostharvest       = _breedingPostharvestFile.isEmpty ? null : _breedingPostharvestFile;
    w.breedingPostharvestRemarks = _breedingPostharvestRemark;
    w.breedingProcessing        = _breedingProcessingFile.isEmpty ? null : _breedingProcessingFile;
    w.breedingProcessingRemarks  = _breedingProcessingRemark;
    // Broiler
    ...
    w.broilerPostharvest        = _broilerPostharvestFile.isEmpty ? null : _broilerPostharvestFile;
    w.broilerPostharvestRemarks  = _broilerPostharvestRemark;
    w.broilerProcessing         = _broilerProcessingFile.isEmpty ? null : _broilerProcessingFile;
    w.broilerProcessingRemarks   = _broilerProcessingRemark;
    // Layer
    ...
    w.layerPostharvest          = _layerPostharvestFile.isEmpty ? null : _layerPostharvestFile;
    w.layerPostharvestRemarks    = _layerPostharvestRemark;
    w.layerProcessing           = _layerProcessingFile.isEmpty ? null : _layerProcessingFile;
    w.layerProcessingRemarks     = _layerProcessingRemark;
  ...
  Widget _dateField(String value, ValueChanged<String> onChanged) =>
    GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          Expanded(child: Text(value.isEmpty ? 'Enter' : value,
  ...
  Widget _attachField(String value, VoidCallback onTap) =>
    GestureDetector(
      onTap: onTap,
      child: Container(
        width: double.infinity,
        ...
        decoration: BoxDecoration(color: Colors.white,
          ...
          border: Border.all(color: const Color(0xFFDDDDDD), width: 1.5)),
        child: Row(children: [
          Expanded(child: Text(value.isEmpty ? 'Attach File' : value,
            style: GoogleFonts.poppins(fontSize: 14,
                color: value.isEmpty ? DAColors.textMuted : DAColors.greenMid))),
  ...
  Widget _remarksToggle(String remarks, ValueChanged<String> onChanged) {
    if (remarks.trim().isNotEmpty) {
      return _field(hint: 'Enter remarks', initial: remarks, onChanged: onChanged);
    }
    return GestureDetector(
      ...
      child: Row(children: [
        ...
        Text('Add Remarks', style: GoogleFonts.poppins(
  ...
  Widget _buildForm() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      // ── Common fields ────────────────────────────────────────
      CropField(label: 'Number of stocks', hint: 'Enter',
      ...
      CropField(label: 'Age of poultry upon receipt (Weeks)', hint: 'Enter',
        initialValue: _ageUponReceipt,
        onChanged: (v) => _ageUponReceipt = v),
      const SizedBox(height: 16),

      CropField(label: 'Average weight upon receipt', hint: 'Enter',
      ...
      if (_landOwnership == 'Others') ...[
        const SizedBox(height: 8),
        CropField(label: 'Please specify', hint: 'Enter',
      ...
      if (w.purposeBreeding) ...[
        ...
        CropField(label: 'Male Stocks', hint: 'Enter',
          initialValue: '',
          keyboardType: TextInputType.number,
          inputFormatters: [FilteringTextInputFormatter.digitsOnly],
          onChanged: (v) {}),
        ...
        CropField(label: 'Female Stocks', hint: 'Enter',
          initialValue: '',
          keyboardType: TextInputType.number,
          inputFormatters: [FilteringTextInputFormatter.digitsOnly],
          onChanged: (v) {}),
        ...
        CropField(label: 'Ratio of Male to Female stocks', hint: 'Enter',
          initialValue: _maleToFemaleRatio,
          onChanged: (v) => _maleToFemaleRatio = v),
        const SizedBox(height: 16),

        CropField(label: 'Number of eggs produced', hint: 'Enter',
        ...
        CropField(label: 'Number of fertile eggs', hint: 'Enter',
        ...
        CropField(label: 'Number of eggs incubated', hint: 'Enter',
        ...
        CropField(label: 'Number of eggs hatched', hint: 'Enter',
        ...
        CropField(label: 'Hatching rate (%)', hint: 'Enter',
        ...
        CropField(label: 'Number of mortality after hatch', hint: 'Enter',
        ...
        ..._chicksSold.asMap().entries.map((e) {
          ...
          return Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              _field(hint: 'Enter', initial: item.age,
        ...
        CropField(label: 'Number of eggs sold', hint: 'Enter',
        ...
        _lbl('Underwent postharvest (Y/N)'),
        const SizedBox(height: 8),
        _attachField(_breedingPostharvestFile,
            () => setState(() => _breedingPostharvestFile = 'postharvest_annex_d.pdf')),
        const SizedBox(height: 8),
        _remarksToggle(_breedingPostharvestRemark,
            (v) => setState(() => _breedingPostharvestRemark = v)),
        const SizedBox(height: 16),

        _lbl('Underwent processing (Y/N)'),
        const SizedBox(height: 8),
        _attachField(_breedingProcessingFile,
            () => setState(() => _breedingProcessingFile = 'processing_annex_e.pdf')),
        const SizedBox(height: 8),
        _remarksToggle(_breedingProcessingRemark,
            (v) => setState(() => _breedingProcessingRemark = v)),
      ...
      if (w.purposeMeat) ...[
        ...
        CropField(label: 'Number of harvested birds', hint: 'Enter No. of harvested birds',
        ...
        CropField(label: 'Total weight harvested', hint: 'Enter Total weight harvested',
        ...
        CropField(label: 'Average Daily Gain (grams)', hint: 'Enter Average Daily Gain',
        ...
        CropField(label: 'Harvest Recovery (%)', hint: 'Enter Percentage of Harvest Recovery',
        ...
        CropField(label: 'Average Live Weight (kg)', hint: 'Enter Average Live Weight',
        ...
        CropField(label: 'Feed Conversion Ratio (kg)', hint: 'Enter Feed Conversion Ratio (kg)',
        ...
        CropField(label: 'Average Age harvested (days)', hint: 'Enter Average Age harvested',
        ...
        CropField(label: 'Birds/Broiler Performance Index', hint: 'Enter Birds/Broiler Performance Index',
        ...
        _lbl('Underwent postharvest (Y/N)'),
        const SizedBox(height: 8),
        _attachField(_broilerPostharvestFile,
            () => setState(() => _broilerPostharvestFile = 'postharvest_annex_d.pdf')),
        const SizedBox(height: 8),
        _remarksToggle(_broilerPostharvestRemark,
            (v) => setState(() => _broilerPostharvestRemark = v)),
        const SizedBox(height: 16),

        _lbl('Underwent processing (Y/N)'),
        const SizedBox(height: 8),
        _attachField(_broilerProcessingFile,
            () => setState(() => _broilerProcessingFile = 'processing_annex_e.pdf')),
        const SizedBox(height: 8),
        _remarksToggle(_broilerProcessingRemark,
            (v) => setState(() => _broilerProcessingRemark = v)),
      ...
      if (w.purposeEgg) ...[
        ...
        CropField(label: 'Ranging Age (in weeks)', hint: 'Enter',
        ...
        CropField(label: 'Total eggs harvested', hint: 'Enter',
        ...
        CropField(label: 'Average harvest rate (%)', hint: 'Enter',
        ...
        CropField(label: 'Weekly % Hen-Day Egg Production', hint: 'Enter',
        ...
        CropField(label: 'Number of days underwent or observed molting', hint: 'Enter',
        ...
        _lbl('Underwent postharvest (Y/N)'),
        const SizedBox(height: 8),
        _attachField(_layerPostharvestFile,
            () => setState(() => _layerPostharvestFile = 'postharvest_annex_d.pdf')),
        const SizedBox(height: 8),
        _remarksToggle(_layerPostharvestRemark,
            (v) => setState(() => _layerPostharvestRemark = v)),
        const SizedBox(height: 16),

        _lbl('Underwent processing (Y/N)'),
        const SizedBox(height: 8),
        _attachField(_layerProcessingFile,
            () => setState(() => _layerProcessingFile = 'processing_annex_e.pdf')),
        const SizedBox(height: 8),
        _remarksToggle(_layerProcessingRemark,
            (v) => setState(() => _layerProcessingRemark = v)),
      ],
