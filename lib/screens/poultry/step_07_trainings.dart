...
import 'poultry_monitoring_summary_screen.dart';
...
class _PoultryStep7State extends State<PoultryStep7Trainings> {
  ...
  void _showModal() {
    final record = PoultryMonitoringRecord(
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min,
          ...
          Text('Record Saved!', style: GoogleFonts.poppins(
            fontSize: 18, fontWeight: FontWeight.w800, color: DAColors.textDark)),
          const SizedBox(height: 6),
          Text('What would you like to do next?', style: GoogleFonts.poppins(
            fontSize: 13, color: DAColors.textMuted)),
          const SizedBox(height: 20),
          _ModalOption(icon: Icons.egg_outlined, title: 'Add Another Batch',
  ...
  Widget build(BuildContext context) => CropFormShell(
    ...
    currentStep:  6, totalSteps: 7, nextLabel: 'Submit',
    onNext: _save, child: _buildForm());

  Widget _buildForm() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text('Trainings Attended', style: GoogleFonts.poppins(
      ...
      Text('Picture of the Farm', style: GoogleFonts.poppins(
          fontSize: 14, fontWeight: FontWeight.w700, color: DAColors.textDark)),
      const SizedBox(height: 10),
      ...
      if (_photoPath.isNotEmpty) ...[
        ...
        GestureDetector(
          ...
          child: Container(width: double.infinity,
            ...
            decoration: BoxDecoration(color: DAColors.greenMid.withOpacity(0.1),
              borderRadius: BorderRadius.circular(14),
        ...
        GestureDetector(
          ...
          child: Container(width: double.infinity,
            ...
            decoration: BoxDecoration(color: DAColors.greenMid,
...
class _ModalOption extends StatelessWidget {
  const _ModalOption({required this.icon, required this.title,
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(title, style: GoogleFonts.poppins(fontSize: 14,
              fontWeight: FontWeight.w700, color: DAColors.textDark)),
          const SizedBox(height: 2),
          Text(subtitle, style: GoogleFonts.poppins(fontSize: 12, color: DAColors.textMuted)),
        ])),
