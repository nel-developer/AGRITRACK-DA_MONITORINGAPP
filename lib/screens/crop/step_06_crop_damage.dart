...
class _CropStep6State extends State<CropStep6CropDamage> {
  ...
  void initState() {
    ...
    _hasHumanDamage = w.hasHumanDamage;
    _pestOccurrence = w.pestOccurrence;
    _pestDate = w.pestDate;
    _pestDamageArea = w.pestDamageArea;
    _pestDamageHa = w.pestDamageHa;
  ...
  List<Widget> _damageAreaHa({
    ...
    required String ha,
    required ValueChanged<String> onHaChanged,
  }) =>
      [
        CropField(
            label: 'Estimated crop damage (area)',
            hint: 'Enter area',
            initialValue: area,
        ...
        CropField(
            label: 'Estimated crop damage (ha)',
            hint: 'Enter hectare',
            initialValue: ha,
            keyboardType: TextInputType.number,
  ...
  List<Widget> _treatmentAttached({
    ...
    required ValueChanged<String> onTreatmentChanged,
    required String attached,
    required ValueChanged<String> onAttachedChanged,
  }) =>
      [
        CropField(
            label: 'Treatment provided/Action taken',
            hint: 'Enter',
    ...
    return Column(
      ...
      children: [
        ...
        if (_hasPest) ...[
          ...
          const SizedBox(height: 14),
          ..._damageAreaHa(
              area: _pestDamageArea,
              onAreaChanged: (v) => _pestDamageArea = v,
              ha: _pestDamageHa,
              onHaChanged: (v) => _pestDamageHa = v),
          const SizedBox(height: 14),
          ..._treatmentAttached(
              treatment: _pestTreatment,
              onTreatmentChanged: (v) => _pestTreatment = v,
              attached: _pestAttached,
              onAttachedChanged: (v) => _pestAttached = v),
          _sectionDivider(),
        ],
        ...
        if (_hasDisease) ...[
          ...
          const SizedBox(height: 14),
          ..._damageAreaHa(
              area: _diseaseDamageArea,
              onAreaChanged: (v) => _diseaseDamageArea = v,
              ha: _diseaseDamageHa,
              onHaChanged: (v) => _diseaseDamageHa = v),
          const SizedBox(height: 14),
          ..._treatmentAttached(
              treatment: _diseaseTreatment,
              onTreatmentChanged: (v) => _diseaseTreatment = v,
              attached: _diseaseAttached,
              onAttachedChanged: (v) => _diseaseAttached = v),
          _sectionDivider(),
        ],
        ...
        if (_hasEnvHazard) ...[
          Text(
              'Environmental hazard affecting the crop production (enumerate per hazard)',
              style: GoogleFonts.poppins(
                  fontSize: 15,
                  fontWeight: FontWeight.w700,
                  color: DAColors.textDark)),
            ...
            return Padding(
              ...
              child: Row(children: [
                Expanded(
                    child: _bareField(
                        hint: 'Enter Ocurrence',
                        initial: _envHazards[i],
                        onChanged: (v) => _envHazards[i] = v)),
                if (i > 0) ...[
                  const SizedBox(width: 8),
          ...
          ..._damageAreaHa(
              area: _envDamageArea,
              onAreaChanged: (v) => _envDamageArea = v,
              ha: _envDamageHa,
              onHaChanged: (v) => _envDamageHa = v),
          const SizedBox(height: 14),
          ..._treatmentAttached(
              treatment: _envTreatment,
              onTreatmentChanged: (v) => _envTreatment = v,
              attached: _envAttached,
              onAttachedChanged: (v) => _envAttached = v),
          _sectionDivider(),
        ],

        // ════ HUMAN-INDUCED ══════════════════════════════════════
        if (_hasHumanDamage) ...[
          Text('Human-induced damage',
              style: GoogleFonts.poppins(
                  fontSize: 15,
                  fontWeight: FontWeight.w700,
                  color: DAColors.textDark)),
          ...
          _bareField(
              hint: 'Enter',
              initial: _humanDamage,
              onChanged: (v) => _humanDamage = v),
          const SizedBox(height: 14),
          CropField(
              label: 'Number of mortality (Human-induced)',
              hint: 'Enter',
              initialValue: _humanMortality,
              keyboardType: TextInputType.number,
              onChanged: (v) => _humanMortality = v),
          const SizedBox(height: 14),
          ..._treatmentAttached(
              treatment: _humanTreatment,
              onTreatmentChanged: (v) => _humanTreatment = v,
              attached: _humanAttached,
              onAttachedChanged: (v) => _humanAttached = v),
          const SizedBox(height: 8),
        ],
        ...
        if (!_hasPest && !_hasDisease && !_hasEnvHazard && !_hasHumanDamage)
          Padding(
            ...
            child: Text(
                'Select at least one damage type from the checklist above.',
                style: GoogleFonts.poppins(
                    fontSize: 13,
