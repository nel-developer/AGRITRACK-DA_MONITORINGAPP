...
class _CropStep4State extends State<CropStep4Fertilization> {
  ...
  bool get _showOrganic =>
      _fertilizerType == 'Organic' || _fertilizerType == 'Both';
  bool get _showInorganic =>
      _fertilizerType == 'Inorganic' || _fertilizerType == 'Both';

  @override
  void initState() {
    super.initState();
    _fertilizerType = w.fertilizerType;
    _organicSource = w.organicSource;
    _organicBagsSAAD = w.organicBagsSAAD;
    _organicBagsComm = w.organicBagsCommercial;
    _organicTotalCost = w.organicTotalCost;
    _organicBagsCycle = w.organicBagsCycle;
    _organicFrequency = w.organicFrequency;
    _inorganicType = w.inorganicType;
    _inorganicBagsSAAD = w.inorganicBagsSAAD;
    _inorganicMeasure = w.inorganicMeasure;
    _inorganicTotalCost = w.inorganicTotalCost;
    _inorganicFrequency = w.inorganicFrequency;
    _pesticideReq = w.pesticideRequirement;
    _inorganicBagsCycle
      ..clear()
      ..addAll(w.inorganicBagsCycle.isEmpty
          ? ['']
          : List<String>.from(w.inorganicBagsCycle));
  }
    ...
    return Column(
      ...
      children: [
        ...
        if (_showOrganic) ...[
          ...
          CropDropdown(
            label:
                'Indicate if organic fertilizer is commercial or produced by FCA',
            hint: 'Choose',
            value: _organicSource,
            items: _organicSourceOptions,
            onChanged: (v) => setState(() => _organicSource = v),
          ),
          const SizedBox(height: 20),
          CropField(
              label: 'Number of bags/kg received from SAAD',
              hint: 'Enter No. of bags',
              initialValue: _organicBagsSAAD,
              keyboardType: TextInputType.number,
              onChanged: (v) => _organicBagsSAAD = v),
          const SizedBox(height: 20),
          if (_organicSource == 'Commercial') ...[
            CropField(
                label: 'Number of bags/kg received from commercial',
                hint: 'Enter No. of bags',
                initialValue: _organicBagsComm,
                keyboardType: TextInputType.number,
                onChanged: (v) => _organicBagsComm = v),
            const SizedBox(height: 20),
          ],
          CropField(
              label:
                  'Total cost of organic fertilizer purchased (based on FCA records)',
              hint: 'Enter the Total cost',
              initialValue: _organicTotalCost,
              keyboardType: TextInputType.number,
              onChanged: (v) => _organicTotalCost = v),
          const SizedBox(height: 20),
          CropField(
              label: 'Total bags used per cropping cycle',
              hint: 'Enter the Total Bags',
              initialValue: _organicBagsCycle,
              keyboardType: TextInputType.number,
              onChanged: (v) => _organicBagsCycle = v),
          const SizedBox(height: 20),
          CropField(
              label: 'Frequency of application from date of planting',
              hint: 'Enter',
              initialValue: _organicFrequency,
        ...
        if (_showInorganic) ...[
          ...
          CropField(
              label: 'Indicate types of inorganic fertilizer used',
              hint: 'Enter',
              initialValue: _inorganicType,
              onChanged: (v) => _inorganicType = v),
          const SizedBox(height: 20),
          _label('Number of bags/kg received from SAAD (per type)'),
          const SizedBox(height: 8),
          _bareField(
              hint: 'Enter the no. of bags',
              initial: _inorganicBagsSAAD,
              onChanged: (v) => _inorganicBagsSAAD = v,
              kb: TextInputType.number),
          const SizedBox(height: 8),
          _bareField(
              hint: 'Type of Measurement',
              initial: _inorganicMeasure,
              onChanged: (v) => _inorganicMeasure = v),
          const SizedBox(height: 20),
          CropField(
              label:
                  'Total cost of inorganic fertilizer purchased (based on FCA records)',
              hint: 'Enter',
              initialValue: _inorganicTotalCost,
              keyboardType: TextInputType.number,
              onChanged: (v) => _inorganicTotalCost = v),
          const SizedBox(height: 20),
            ...
            return Padding(
              ...
              child: Row(children: [
                Expanded(
                    child: _bareField(
                        hint: 'Enter',
                        initial: _inorganicBagsCycle[i],
                        onChanged: (v) => _inorganicBagsCycle[i] = v,
                        kb: TextInputType.number)),
                if (i > 0) ...[
                  const SizedBox(width: 8),
                  _removeBtn(
                      () => setState(() => _inorganicBagsCycle.removeAt(i))),
                ],
              ]),
            );
          }),
          _addBtn(
              'Add Cycle', () => setState(() => _inorganicBagsCycle.add(''))),
          const SizedBox(height: 20),
          CropField(
              label:
                  'Frequency of application from date of planting (per type)',
              hint: 'Enter',
              initialValue: _inorganicFrequency,
        ...
        CropField(
            label: 'Insert pesticide requirement',
            hint: 'Enter',
            initialValue: _pesticideReq,
            onChanged: (v) => _pesticideReq = v),
